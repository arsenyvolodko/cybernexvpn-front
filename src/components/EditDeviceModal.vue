...
const type = ref(props.device.type && props.device.type !== 'unknown' ? props.device.type : 'android')
...
<template>
  <div class="overlay" @click.self="emit('close')">
    <div class="modal">
      ...
      <div class="form">
        <label class="field">
          <span class="field-label">Имя устройства <span class="required">*</span></span>
